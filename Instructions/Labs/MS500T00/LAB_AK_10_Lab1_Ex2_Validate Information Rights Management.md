...
5. 「**Create a site**」 ウィンドウで、「**Team site**」 を選択します。

6. 「**Get a team site connected to Microsoft 365 Groups**」 ウィンドウで次の属性を入力します。

	- Site name: `Marketing1`  
...
9. 新しい SharePoint サイトが作成されるのを待ちます。これには最高 15 分かかる場合があります。新しい Marketing1 サイト コレクションが 「**アクティブなサイト**」 コレクション リストに表示されますが、作成中はサイト コレクションの右側で「処理中」の円が引き続きスピンします。 

9. Marketing サイト コレクションが作成されたら、サイト コレクションの右側に 「**新規**」 と表示されます。

10. Web ブラウザーで新しいタブを開き、以下に接続します: `https://M365xZZZZZZ.sharepoint.com/sites/marketing1` (ZZZZZZ はラボ ホスティング プロバイダーから提供されるテナント ID)

11. **Marketing1** サイトの左側のナビゲーション ペインで 「**ドキュメント**」 を選択します。 

12. 「**We’ve got a new look**」 ウィンドウが表示されたら、「**後で**」 を選択します。

13. **Marketing1** サイトの 「**ドキュメント**」 ページの右上で**歯車** (**設定)** アイコンを選択し、「**ライブラリの設定**」 を選択します。 
