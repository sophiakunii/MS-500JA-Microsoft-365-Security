...
6.  「**所有者の割り当て**」 画面で、「**+所有者の割り当て**」をクリックします。

8.  「**MOD 管理者**」を検索します。「**MOD Administrator**」 を選択して 「**追加 (1)**」 をクリックします。

10. 「**所有者の割り当て**」 画面で、「**次へ**」 を選択します。

6.  「**メンバーの追加**」 画面で、「**+メンバーの追加**」をクリックします。

10.  「**メンバーを追加**」 画面で「**MOD 管理者**」を検索します。「**MOD Administrator**」 を選択して 「**追加 (1)**」 をクリックします。

6.  「**メンバーの追加**」 画面で、「**次へ**」 を選択します。

8.  「**設定の編集**」 画面で、「**グループのメールアドレス**」として `access と入力し、「**次へ**」 を選択します。

7.  「**グループを作成**」 を選択します。「**閉じる**」 を選択します。
