...
2.  **Azure Active Directory** を参照し、「**セキュリティ**」 をクリックし、「**保護**」 ブレードで 「**条件付きアクセス**」 を選択します。
...
5.  「**ユーザーとグループ**」 をクリックし、「**ユーザーとグループの選択**」 ラジオ ボタンを選択します。  「**ユーザーとグループ**」 のチェック ボックスをオンにし、「**選択**」 をクリックします。
